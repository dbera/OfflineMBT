...
class TestSCN:
    ...
    def generateTSpec(self, idx, sutTypesList, sutVarTransitionMap, transitionQnameMap, output_dir):
        ...
        txt += "using printer.PrintFactoryAssertions.inspectionReport\n"
        txt += "using printer.PrintFactoryAssertions.history\n"
        txt += "using printer.PrintFactoryAssertions.Event_1bxlea2\n"
