...
class Data:
    ...
    def execute_Root_T1_default_Event_1bks5sc(Event_0o4qsh5):
    	try:
    	    ...
    	    __location = Location(26,26,487,30,"Event_1bks5sc := Event_0o4qsh5")
    	...
    	try:
    	    ...
    	    __location = Location(27,31,530,90,"if true then // Empty else // Empty fi")
    	    __source_file = "issue371.ps"
    	    get_reporting().exception(str(e), e, details=__location.text, source=__source_file, location=__location)
    	try:
    	    ...
    	    __location = Location(32,34,633,67,"for int i in range(2) do // Empty end-for")
    	    __source_file = "issue371.ps"
    	    get_reporting().exception(str(e), e, details=__location.text, source=__source_file, location=__location)
    	try:
    	    if not (False):
    	    ...
    	    __location = Location(35,37,713,73,"if not false then Event_1bks5sc.myField := 1 fi")
    	    __source_file = "issue371.ps"
    	    get_reporting().exception(str(e), e, details=__location.text, source=__source_file, location=__location)
