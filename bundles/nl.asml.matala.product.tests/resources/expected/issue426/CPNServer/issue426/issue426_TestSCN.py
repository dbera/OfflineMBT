...
# from .issue426.issue426_types import Types
...
class TestSCN:
    ...
    def generateTSpec(self, idx, sutTypesList, sutVarTransitionMap, transitionQnameMap, output_dir):
        txt = ""
        txt += "import " + '"' + str(self.pspec_path) + "issue426.ps" + '"' +"\n\n"
        txt += "using issue426.Issue426.params\n"
        txt += "using issue426.Issue426.Event_01uaof6\n"
        txt += "using issue426.Issue426.Event_04j9655\n"
        txt += "using issue426.Issue426.Flow_1ew3pv8\n"
        txt += "using issue426.Issue426.Flow_11d1u6w\n"
        txt += "using issue426.Issue426.Flow_109yqzk\n"
