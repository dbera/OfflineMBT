...
if __package__ is None or __package__ == '':
    from issue426_TestSCN import TestSCN, Step, Tests, Constraint, CEntry
    from issue426_data import Data
    from issue426_reporting import get_reporting, initialize_reporting, Location, Severity
    from issue426_Simulation import Simulation, simulate
else:
    from .issue426_TestSCN import TestSCN, Step, Tests, Constraint, CEntry
    from .issue426_data import Data
    from .issue426_reporting import get_reporting, initialize_reporting, Location, Severity
...
class issue426Model:
    ...
    def __init__(self):
        ...
        self.rg_txt += '[*] --> 0\n'
        self.listOfEnvBlocks = ["Issue426"]
        self.listOfSUTActions = ["Issue426_D_default","Issue426_C_default"]
        self.mapOfSuppressTransitionVars = {}
        self.mapOfTransitionQnames = {'Issue426_D_default': 'issue426.Issue426.D.default','Issue426_C_default': 'issue426.Issue426.C.default'}
        self.n = PetriNet('issue426')
        self.n.globals["Data"] = Data
        self.n.globals.declare("import json")
        self.n.add_place(Place('params'))
        self.n.add_place(Place('Event_01uaof6'))
        self.n.add_place(Place('Event_04j9655'))
        self.n.add_place(Place('Flow_1ew3pv8'))
        self.n.add_place(Place('Flow_11d1u6w'))
        self.n.add_place(Place('Flow_109yqzk'))
        self.n.place('Event_01uaof6').empty()
        self.n.place('Event_01uaof6').add(json.dumps({"id": 1, "counter": 0}))
        self.n.add_transition(PrioritizedTransition('Issue426_D_default@TheRun@RUN@', 0))
        self.n.add_transition(PrioritizedTransition('Issue426_C_default@null@COMPOSE@', 0))
        self.n.add_transition(PrioritizedTransition('Issue426_A_default@null@INTERNAL@', 0))
        self.n.add_transition(PrioritizedTransition('Issue426_B_default@null@INTERNAL@', 0))
        self.n.add_input('Flow_11d1u6w','Issue426_D_default@TheRun@RUN@',Variable('v_Flow_11d1u6w'))
        self.n.add_input('params','Issue426_D_default@TheRun@RUN@',Variable('v_params'))
        self.n.add_input('Flow_1ew3pv8','Issue426_B_default@null@INTERNAL@',Variable('v_Flow_1ew3pv8'))
        self.n.add_input('Event_01uaof6','Issue426_A_default@null@INTERNAL@',Variable('v_Event_01uaof6'))
        self.n.add_input('Flow_109yqzk','Issue426_C_default@null@COMPOSE@',Variable('v_Flow_109yqzk'))
        self.n.add_output('Event_04j9655','Issue426_D_default@TheRun@RUN@', Expression('Data().execute_Issue426_D_default_Event_04j9655(json.loads(v_Flow_11d1u6w, object_pairs_hook=Data().int_keys),json.loads(v_params, object_pairs_hook=Data().int_keys))'))
        self.n.add_output('Flow_109yqzk','Issue426_B_default@null@INTERNAL@', Expression('Data().execute_Issue426_B_default_Flow_109yqzk(json.loads(v_Flow_1ew3pv8, object_pairs_hook=Data().int_keys))'))
        self.n.add_output('Flow_1ew3pv8','Issue426_A_default@null@INTERNAL@', Expression('Data().execute_Issue426_A_default_Flow_1ew3pv8(json.loads(v_Event_01uaof6, object_pairs_hook=Data().int_keys))'))
        self.n.add_output('Flow_11d1u6w','Issue426_C_default@null@COMPOSE@', Expression('Data().execute_Issue426_C_default_Flow_11d1u6w(json.loads(v_Flow_109yqzk, object_pairs_hook=Data().int_keys))'))
        self.n.add_output('params','Issue426_C_default@null@COMPOSE@', Expression('Data().execute_Issue426_C_default_params(json.loads(v_Flow_109yqzk, object_pairs_hook=Data().int_keys))'))
    ...
    def initializeTestGeneration(self):
        ...
        # tr_assert_ref_dict = {}
        # map_transition_assert = {}
        self.map_transition_assert = {'Issue426_C_default@null@COMPOSE@': ['params']}
