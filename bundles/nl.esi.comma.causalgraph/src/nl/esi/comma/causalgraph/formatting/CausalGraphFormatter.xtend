...
class CausalGraphFormatter extends AbstractDeclarativeFormatter {
    ...
    override protected configureFormatting(FormattingConfig it) {
        ...
        setLinewrap(1,1,2).before(causalGraphAccess.languageKeyword_7_0)
        setLinewrap(1,2,2).before(causalGraphAccess.headerKeyword_8_0)
        setLinewrap(1,2,2).before(causalGraphAccess.typesKeyword_9_0)
        setLinewrap(1,1,1).before(typeDeclRule)
        setLinewrap(1,2,2).before(causalGraphAccess.functionsKeyword_10_0)
        setLinewrap(1,1,1).before(functionDeclRule)
        setLinewrap(1,2,2).before(causalGraphAccess.variablesKeyword_11_0)
        setLinewrap(1,1,1).before(variableRule)
        setLinewrap(1,2,2).before(causalGraphAccess.initializationsKeyword_12_0)
        setLinewrap(1,1,1).before(assignmentActionRule)
        setLinewrap(1,2,2).before(causalGraphAccess.edgesKeyword_14_0)
        ...
        setIndentationIncrement.after(causalGraphAccess.graphKeyword_4)
...
//        setIndentationDecrement.after(scenarioStepRule)
        setIndentationDecrement.before(causalGraphAccess.edgesKeyword_14_0)
        setIndentationIncrement.after(causalGraphAccess.edgesKeyword_14_0)
   }
}