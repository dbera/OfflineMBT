package nl.esi.comma.testspecification.generator.abstractToConcrete
...
import nl.esi.comma.testspecification.generator.utils.ExpressionGenerator
...
«ENDFOR»
    ...
    def printSymbolicContraint(String prefix, ConstraintStep step, EList<RunStep> runSteps,
        EList<ComposeStep> composeSteps) {
        var sc = ""
        for (s : step.ce) {
            for (a : s.act.actions) {
