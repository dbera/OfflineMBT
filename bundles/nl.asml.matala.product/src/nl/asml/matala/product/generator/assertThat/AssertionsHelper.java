package nl.asml.matala.product.generator.assertThat;

import nl.esi.comma.assertthat.assertThat.DataCheckItems;
import nl.asml.matala.product.generator.assertThat.AssertionsUtils.AssertThatValueEqualTo;
import nl.asml.matala.product.generator.assertThat.AssertionsUtils.AssertThatXPath;
import nl.asml.matala.product.generator.assertThat.AssertionsUtils.AssertionAbstract.WithinMargin;
...
public class AssertionsHelper {
	...
	public static String printAssertion(DataCheckItems ref) {
...
//    	
//    	for (Expression param : ref.getParams().getParamsPositional().getValues()) {
//    		Map<String,String> paramMap = new HashMap<>() {{
//    			put("type", "OUTPUT");
//    			put("value", param.toString());
//    			put(null, null);
//    		}};
	...
	static String printAssertion(AssertThatBlock ref) {
		if (ref.getVal() != null) {
			...
			if (atval.getAssertEq() != null) {
				...
				obj.output = new JsonPrimitive(val.getOutRef().toString());
				if (val.isAsRegex()) {
